...
def question_one():
    ...
    print(
        "There are %d different conversion types according to" +
        "Python Documentation" % 16)
...
def question_three():
    ...
    print('.... ("drum beats") the .%(method)s method take over the string' +
                "formatting world?" % {u'method': u"format"}
            )
...
if __name__ == '__main__':
    ...
    question_one()
    print(
        '#Question 2: Why do we have %i and %d for ints' +
         'and %f and %F for floats?'
         )
    question_two()
    print(
        '#Question 3: Will the .format option take over all string operations?')
